...
public class BotServ {
	...
	/**
	 * True if --nogui was specified in the run flags If this is true, the server
	 * will run in headless mode/wont take in any console commands
	 */
	...
	/**
	 * True if --nopkg was specified in the run flags If this is true, the server
	 * will not instaniate the PackageManager
	 */
	 ...
	 * 
	 * @param args
	 *            - The flags specified on the JAR run
	 */
	...
	/**
	 * Notifies the server that the bot has successfully logged in and: * Starts the
	 * package manager * Registers console commands * Enables the console command
	 * prompt
	 * 
	 * @param event
	 *            - The {@link JDA Bot instance}
	 * @throws JSONException
	 *             - If we encountered a error while reading the settings.json
	 * @throws IOException
	 ...
	 * 
	 * @param cmd
	 *            - The keyword to identify the command
	 * @param runner
	 *            - The {@link ConsoleCommand ConsoleCommand} object to invoke
	 */
	...
	/**
	 * Handles the raw string given when a console command is entered
	 * This will also run {@link BotServ#scanAgain()} after it is done handling. 
